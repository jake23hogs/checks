...
class Ninth(Checks):
    ...
    def test1(self):
        ...
        self.spawn("java Ninth").stdin("56 300 89 299 254 7 85 98 71 111 221").stdout("300\n", "300\n").exit(0)

    @check("compiles")
    def test2(self):
        """Outputs 721 for the max number"""
        self.spawn("java Ninth").stdin("566 325 721 9 0099 654 720 685 38 71 111 221").stdout("721\n", "721\n").exit(0)
